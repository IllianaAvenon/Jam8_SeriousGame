...
public class StatsUI : MonoBehaviour
{
	...
	void Update () {
        ...
        SleepStatScale.x = Mathf.Clamp(gameManager.currentStats.Sleep / 10, 0.0f, 1.0f);
        ThirstStatScale.x = Mathf.Clamp(gameManager.currentStats.Thirst / 10.0f, 0.0f, 1.0f);
        HungerStatScale.x = Mathf.Clamp(gameManager.currentStats.Hunger / 10.0f, 0.0f, 1.0f);
        CleanlinessStatScale.x = Mathf.Clamp(gameManager.currentStats.Cleanliness / 10.0f, 0.0f, 1.0f);
